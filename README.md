...
3. Upload all 5 files: `index.html`, `script.js`, `worker.js`, `style.css`, `README.md`
4. Commit to `main`
5. Go to **Settings → Pages**
6. Set source to **Deploy from a branch**, branch = `main`, folder = `/ (root)`
7. Click Save — your site will be live at:
```
