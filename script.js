...
// by Monaco's AMD loader (identified by the presence of `require.defined`,
// a method that Monaco's loader always exports).  It resolves the returned
// Promise only once that condition is true, then calls the AMD require for
...
function waitForMonacoRequire(timeout = 15000) {
  return new Promise((resolve, reject) => {
    ...
    function check() {
      // Monaco's AMD loader replaces the plain-object `require` stub with a
      // callable function that also has a `.defined` method.
